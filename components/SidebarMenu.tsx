...
export const SidebarMenu: React.FC<SidebarMenuProps> = ({
  ...
  <div
    ref={sidebarRef}
    className={`w-72 min-h-screen p-4 flex flex-col fixed top-0 left-0 justify-between z-50 transition-all duration-700
      ${focused ? "w-full bg-[linear-gradient(90deg,_#000_0%,_#000_15%,_rgba(0,212,255,0)_100%)]" : "bg-transparent"}
    `}
  >
    {/* Profile Section */}
    <div
