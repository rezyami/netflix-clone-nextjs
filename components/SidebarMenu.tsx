...
export const SidebarMenu: React.FC = () => (
  <div className="w-full h-full bg-[linear-gradient(90deg,_#000_0%,_#000_15%,_rgba(0,212,255,0)_100%)] flex flex-col fixed top-0 left-0">
    {/* Profile Section */}
    <div className="opacity-0 -translate-x-5 transition-all duration-100 ease-linear">
